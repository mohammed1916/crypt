    ...
    return (
      <button
        ...
        className={cn(
          ...
          variant === "acrylic" ? "bg-gradient-to-r from-teal-400/20 via-violet-500/20 to-blue-400/20 bg-clip-padding backdrop-blur-2xl border border-white/20 text-gray-900 dark:text-white shadow-lg hover:opacity-90" : variant === "default" ? "bg-primary text-primary-foreground hover:bg-primary/90" : "border border-input bg-background hover:bg-accent hover:text-accent-foreground",
