    ...
    return (
      <button
        ...
        className={cn(
          ...
          appliedVariant === "acrylic" ? "bg-gradient-to-r from-blue-400/20 via-purple-500/20 to-blue-400/20 bg-clip-padding backdrop-blur-2xl border border-white/20 text-white dark:text-white shadow-lg hover:opacity-90" : appliedVariant === "default" ? "bg-primary text-primary-foreground hover:bg-primary/90" : "border border-input bg-background hover:bg-accent hover:text-accent-foreground",
